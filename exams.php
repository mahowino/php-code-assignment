...
<head>
	...
	<style type="text/css">
		.form{position: absolute;left: 350px;top: 100px;background-color:|#131000;border: 2px solid black;padding: 20px;box-sizing: border-box;box-shadow: .6;background-color: black;opacity: .8;width: 400px;height: 440px;text-align: left;border-radius: 2px}
		...
		span{color: white}	.container .nav li a{}
				...
				.container .nav li a:hover{background-color: red;padding: 15px;text-decoration: none;border-radius: 5px}		.icon{float: left;width: 50%;height: 70px;text-align: left;}
	</style>
</head>
<body style="background-image: url(NCLEX-Tips.jpg);background-size: cover;background-repeat: no-repeat;"> 
	<div class="container">
